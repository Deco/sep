...
typedef boost::variant<
    /* STRING  */ std::string,
    /* INT64   */ uint64_t, //uint64_t
    /* FLOAT64 */ float,//float64_t,
    /* BOOL    */ bool,
...
public:
    ...
    std::vector<std::string> getList(){ return keyList; }
...
//protected:
    ...
    */
    Param(
        ...
        ParamAddress &fullAddressIn, // changed from && for both fields
        ParamType &typeIn, 
...
public:
    ...
    //void updateParam(ParamAddress oldParam, Param newParam);
